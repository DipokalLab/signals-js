...
* @returns {Uint32Array}
*/
export function return_array(x) {
    const ptr0 = passArrayF64ToWasm0(x, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.return_array(ptr0, len0);
...
export function __wbg_log_7750271c4c3f356d(arg0, arg1) {
...
export function __wbg_new_2afb9348997957e9(arg0) {
